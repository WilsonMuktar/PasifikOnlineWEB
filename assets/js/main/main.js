            ...
            <li ${highLightNavBar} class="nav-item">
                <a class="nav-link " href="${navBar["nav_path"]}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="${navBar["nav_icon"]} text-sm opacity-10"></i>
                    </div>
...
function processExpenseTable(response){
    var data = response.data;
    var rows = "";
...
function processDebtTable(response){
    var data = response.data;
    var rows = "";
...
function processReportTable(response, transaction_date_from, transaction_date_to, order_by, order_type ) {
    ...
    Object.entries(KAPALlist).forEach((([key, value], index) => {
        if (key !== "undefined") {
            namaKapal = key
            KapalListElements += `
                        <div class="col-xl-3 col-sm-3 col-3 mb-xl-0 mb-4 p-2"" onclick="redirectPage('./pages/transaction.html?except_transaction_type=FishDebtCollect&transaction_date_from=${transaction_date_from}&transaction_date_to=${transaction_date_to}&order_by=${order_by}&order_type=${order_type}')">
...
function processPopup(title, title_extra, data) {
    ...
    `, function (){
        ...
        case 'Add Expense':
            MAKE_REQUEST("GET",product_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add expense get product list failed!")
                    return
                }
                data = response.data;
                options = "<option disabled selected value data-i18n-key=\"select_product\"> -- Select Product -- </option>"
            ...
            MAKE_REQUEST("GET",vessel_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add expense get vessel list failed!")
                    return
                }
                data = response.data;
                options = "<option selected value='' data-i18n-key=\"select_vessel\"> -- Select Vessel -- </option>"
            ...
            MAKE_REQUEST("GET",trip_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add expense get trip list failed!")
                    return
                }
                data = response.data;
                options = "<option selected value='' data-i18n-key=\"select_trip\"> -- Select Trip -- </option>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="transaction_type" class="form-control-label" data-i18n-key="transaction_type">Transaction Type</label>
                            <select id="transaction_type" class="form-control" data-toggle="select">
                                <option value="Purchase" data-i18n-key="purchase" selected>Purchase</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    `, function (){
        ...
        case 'Add Debt':
            MAKE_REQUEST("GET",product_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add debt get product list failed!")
                    return
                }
                data = response.data;
                options = "<option disabled selected value data-i18n-key=\"select_product\"> -- Select Product -- </option>"
            ...
            MAKE_REQUEST("GET",people_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add debt get people list failed!")
                    return
                }
                data = response.data;
                currentPeopleGroup = "";
            ...
            MAKE_REQUEST("GET",vessel_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add debt get vessel list failed!")
                    return
                }
                data = response.data;
                options = "<option selected value='' data-i18n-key=\"select_vessel\"> -- Select Vessel -- </option>"
            ...
            MAKE_REQUEST("GET",trip_api_url,"",true, function(response) {
                if (response instanceof Error) {
                    alert("Add debt get trip list failed!")
                    return
                }
                data = response.data;
                options = "<option selected value='' data-i18n-key=\"select_trip\"> -- Select Trip -- </option>"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="transaction_type" class="form-control-label" data-i18n-key="transaction_type">Transaction Type</label>
                            <select id="transaction_type" class="form-control" data-toggle="select">
                                <option value="Debt" data-i18n-key="debt" selected>Debt</option>
                                <option value="DebtCollect" data-i18n-key="debt_collect">DebtCollect</option>
                            </select>
                        </div>
                    </div>
